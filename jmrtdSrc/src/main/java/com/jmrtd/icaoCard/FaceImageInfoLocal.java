 ...
 * @author gapps
 */
public class FaceImageInfoLocal extends AbstractImageInfo {
	 ...
	 */
	public FaceImageInfoLocal(Gender gender, EyeColor eyeColor,
			int featureMask,
			int hairColor,
			int expression,
	 ...
	 */
	public FaceImageInfoLocal(InputStream inputStream) throws IOException {
		super(TYPE_PORTRAIT);
